      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8 relative z-10 space-y-10">
        ...
        <header className="grid grid-cols-1 md:grid-cols-5 border-t-2 border-b-2 border-blue-700 text-blue-900 items-center">
          ...
          <div className="p-4 flex justify-between items-center gap-2">
            {!gitToken ? (
              <a href="/api/auth/github" className="flex items-center gap-2 bg-blue-700 hover:bg-blue-600 text-slate-100 font-mono font-bold px-3 py-1.5 border border-blue-800 transition-all text-[10px]">
