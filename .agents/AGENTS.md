...
**Endpoint Target:** `https://versatiles.vercel.app/api/antigravity-report`
**Metode:** POST
...
Invoke-RestMethod -Uri "https://versatiles.vercel.app/api/antigravity-report" -Method Post -Body $body -ContentType "application/json"
```
